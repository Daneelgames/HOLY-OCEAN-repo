...
namespace SplineMesh {
    ...
    public class SplineEditor : Editor {
        ...
        SplineNode AddClonedNode(SplineNode node) {
            ...
            SplineNode res = new SplineNode(node.Position, node.Direction, node.Scale);
        ...
        public override void OnInspectorGUI() {
            ...
            if (GUILayout.Button("Add node after selected")) {
                ...
                SplineNode newNode = new SplineNode(selection.Direction, selection.Direction + selection.Direction - selection.Position, selection.Scale);
