...
namespace GPUInstancer
{
    public static class GPUInstancerUtility
    {
        ...
        public static void CopyTextureArrayWithComputeShader(Texture source, Texture destination, int offsetX, int sourceMip = 0, int destinationMip = 0, bool reverseZ = true)
        {
