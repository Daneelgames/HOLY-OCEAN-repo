    ...
    public class TiltShiftRenderer : ScriptableRendererFeature
    {
        class TiltShiftRenderPass : PostEffectRenderer<TiltShift>
        {
            ...
            protected override void ConfigurePass(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
            {
                ...
                screenCopy = GetTemporaryRT(ref screenCopy, cameraTextureDescriptor, cameraTextureDescriptor.graphicsFormat, FilterMode.Bilinear, "BlurredColor");
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                FinalBlit(this, context, cmd, renderingData, TiltShift.debug ? (int)Pass.FragDebug : (int)Pass.FragBlend);
            }
